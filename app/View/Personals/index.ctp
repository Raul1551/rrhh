    ...
    <div id="menuModulo" class="row navbar  navbar-default navbar-fixed-top">
        <div id="columnaBotonesUsuario" class="col-md-12">
            <ul class="nav navbar-nav pull-right">
                ...
                <li>
                    <a class="disabled fa fa-pencil fa-lg" title="Modificar Registro" id="editRegistro" data-editRegistro="<?php echo $idRegistro; ?>" href="#"></a>
                </li>
                <li>
            ...
            <div class="modal-dialog  modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="dialogBodypersonalModalPrincipalDialog" style="max-height: 89.2142vh; overflow-y: auto;">
                        ...
                        <form class="cuerpo-contenedor" action="/personals/add" id="PersonalEditForm" method="post" accept-charset="UTF-8" novalidate="novalidate">
                            <legend id="cabeceraInfo_9152" class="text-seccion alert-info legendStrata">Datos generales del personal</legend>
                            <div id="fila2" class="row">
                                <div id="columna2" class="col-md-2" style="padding-right: 5px; padding-left: 15px;">
                                    <div id="dniDiv" class="form-group">
...
<script>
$(document).ready(function() {
    // Evento para abrir el modal cuando se hace clic en el botón "Editar"
    $('#editRegistro').on('click', function() {
        // Obtener el ID del registro desde el atributo data
        var idRegistro = $(this).data('editRegistro');
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    // Cargar los datos del registro en el formulario del modal
                    cargarDatosRegistro(data.registro);
                } else {
                    // Manejar el caso en el que no se pueda cargar el registro
    ...
    // Función para cargar los datos del registro en el formulario
    function cargarDatosRegistro(registro) {
        $('#dni').val(registro.Personal.dni);
        // Aquí continúa con la carga de otros campos...
    }
});
</script>