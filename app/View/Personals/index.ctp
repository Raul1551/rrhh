    ...
    <div id="menuModulo" class="row navbar  navbar-default navbar-fixed-top">
        <div id="columnaBotonesUsuario" class="col-md-12">
            <ul class="nav navbar-nav pull-right">
                ...
                <li>
                    <a class="disabled fa fa-pencil fa-lg" title="Modificar Registro" data-target="personalModalEditarPrincipalDiv" id="editRegistro" href="#"></a>
                </li>
                <li>
    ...
    $(document).ready(function() {
        ...
        $("#editRegistro").on("click", function(event) {
            ...
            var idRegistro = obtenerIdRegistroSeleccionado();
                ...
                // Ahora, el botón tiene el ID del registro seleccionado almacenado en data-idregistro.
                console.log('ID del registro seleccionado:', idRegistro);
            // Realiza una solicitud AJAX para obtener los datos del registro
            $.ajax({
                type: 'GET',
                url: 'personals/edit/' + idRegistro, // Reemplaza con la URL correcta
                dataType: 'json',
                success: function(data) {
                    if (data.success) {
                        // Redirige a la página edit.ctp y pasa los datos del registro como parámetros GET
                        window.location.href = 'edit.ctp?id=' + data.registro.id;
                    } else {
                        // Maneja el caso en el que no se puedan cargar los datos del registro
                        alert('Error al cargar los datos del registro.');
                    }
                },
                error: function() {
