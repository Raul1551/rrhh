...
(function(root, factory) {
	...
	elFinder.prototype.i18.es = {
		...
		messages   : {
			...
			'errReplByChild'       : 'La carpeta no puede ser reemplazada por un elemento contenido en ella.',
			...
			'confirmRm'       : '¿Estás seguro de querer eliminar archivos?<br/>¡Esto no se puede deshacer!',
			...
			'facebook'        : 'Unete a nosotros en Facebook',
			'team'            : 'Equipo',
