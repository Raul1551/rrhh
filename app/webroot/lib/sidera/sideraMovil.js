...
/*Add y Edit*/
    ...
    jQuery.fn.cargarLibreriaSelectpicker = function(controlador){
        ...
        $((controlador == "" ? '' :'#'+controlador+'Div ')+'.selectpicker').selectpicker();
    ...
    jQuery.fn.cargarLibreriaDatetimepicker = function(controlador){   
        var controlador = controlador || '';
        $((controlador == "" ? '' :'#'+controlador+'Div ')+'form .date').datetimepicker({locale: 'es',format:'L',showClear:true,minDate :'1800-01-01',widgetPositioning: {vertical: 'bottom'}}).on('dp.show', function () { $('#'+this.id+'Input').attr("readonly","readonly");}).on('dp.hide', function () { $('#'+this.id+'Input').removeAttr("readonly");});
        $((controlador == "" ? '' :'#'+controlador+'Div ')+'form .datetime').datetimepicker({locale: 'es',format:'L HH:mm:ss',showClear:true,minDate :'1800-01-01',widgetPositioning: {vertical: 'bottom'}}).on('dp.show', function () { $('#'+this.id+'Input').attr("readonly","readonly");}).on('dp.hide', function () { $('#'+this.id+'Input').removeAttr("readonly");});
        $((controlador == "" ? '' :'#'+controlador+'Div ')+'form .time').datetimepicker({locale: 'es',format:'HH:mm',showClear:true,widgetPositioning: {vertical: 'bottom'}}).on('dp.show', function () { $('#'+this.id+'Input').attr("readonly","readonly");}).on('dp.hide', function () { $('#'+this.id+'Input').removeAttr("readonly");});
        $((controlador == "" ? '' :'#'+controlador+'Div ')+'form .mesano').datetimepicker({locale: 'es',viewMode: 'years',format:'MM/YYYY',showClear:true,minDate :'1800-01-01',widgetPositioning: {vertical: 'bottom'}}).on('dp.show', function () { $('#'+this.id+'Input').attr("readonly","readonly");}).on('dp.hide', function () { $('#'+this.id+'Input').removeAttr("readonly");});
        $((controlador == "" ? '' :'#'+controlador+'Div ')+'form .ano').datetimepicker({locale: 'es',viewMode: 'years',format:'YYYY',showClear:true,minDate :'1800-01-01',widgetPositioning: {vertical: 'bottom'}}).on('dp.show', function () { $('#'+this.id+'Input').attr("readonly","readonly");}).on('dp.hide', function () { $('#'+this.id+'Input').removeAttr("readonly");});
    }
    ...
    jQuery.fn.validarFormulario = function(controlador){
        ...
        $((controlador == "" ? '' :'#'+controlador+'Div ')+'form').each(function() {
            $(this).validate({ignore: ".noValidar",
                              errorElement: "span",
...
/*Index*/
    ...
    jQuery.fn.cargarLibreriaSelectpickerIndexModal = function(subgrid){
        var subgrid = subgrid || '';
        $((subgrid == "" ? '' :'#'+subgrid+' ')+'.selectpicker').selectpicker();
    }
