...
class VestuariosController extends AppController
{
    ...
    public function view($id = null)
    {
        ...
        if (!$id) {
            ...
            $registro = $this->Vestuario->findById($id);
        ...
        if (!$id) {
            ...
            if (!$registro) {
                ...
                if ($this->request->is(['post', 'put'])) {
                    ...
                    $this->request->data['Vestuario']['id'] = $id;
    ...
    public function delete()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if (!empty($ids)) {
                ...
                if ($this->Vestuario->deleteAll(array('Vestuario.id' => $ids))) {
